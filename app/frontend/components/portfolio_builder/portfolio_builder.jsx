      ...
      <main className="main flex-start">
        ...
        <article className="portfolio-builder-container">
          ...
          <ExperienceBuilder
            ...
            experienceSection={
              this.props.portfolio
                ? this.props.portfolio.taggedInfo[this.state.tagIdx]
                    .experienceSection
                : { title: "loading portfolio", subtitle: "loading portfolio" }
            }
          />
  ...
  renderEditingTools() {
    ...
    return (
      <div className="editing-tools">
        ...
        <h2>
          Edit different portfolio focuses to tailor content to different job
          postings.
        </h2>
        <form
          className="editing-tools-tag-form"
        ...
        >
          ...
          <select
            ...
            onChange={
              this.props.portfolio ? this.selectNewTag.bind(this) : null
            }
          >
            {this.props.portfolio ? (
              this.props.portfolio.taggedInfo.map(el => (
                <option value={el.tagName}>{el.tagName}</option>
              ))
            ) : (
          ...
          <input
            type="text"
            placeholder="Choose a new focus (e.g. edutech)"
          ...
          <input
            type="submit"
            value="Create new portfolio focus!"
            className="submit-portfolio-tag-button"
          />
        </form>
        <button
